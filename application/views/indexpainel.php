    ...
    $menus = array(
        ...
        "configuracoes" => array(
            ...
            "submenu" => array(
                ...
                "boasvindas" => array(
                    "url" => "Painel/emails/boasvindas",
                    "title" => "Boas vindas",
                    "ajax" => false
                ),
                [
                    "url" => "Painel/emails/senha",
                    "title" => "Recuperação de senha",
                    "ajax"=> false
                ],
                [
                    "url" => "Painel/emails/compraassinatura",
                    "title" => "Compra de assinatura",
                    "ajax"=> false
                ],
                [
                    "url" => "Painel/emails/comprapresente",
                    "title" => "Compra aprovada de presente",
                    "ajax"=> false
                ],
                [
                    "url" => "Painel/emails/comfirmaconvidado",
                    "title" => "Confirmação de convidado",
                    "ajax"=> false
                ],
                [
                    "url" => "Painel/emails/dominioativo",
                    "title" => "Dominio ativado",
                    "ajax"=> false
                ],
...
<body data-layout="detached" data-topbar="colored">
    ...
    $(document).ready(function() {
        ClassicEditor.create(document.querySelector('#editor'), {
            ...
            ckfinder: {
                uploadUrl: '<?=base_url("Painel/envImg/".$nav)?>',
            },
            language: 'pt-br',
