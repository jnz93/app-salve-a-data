...
<head>
    ...
    <link rel="stylesheet" href="<?=base_url("assets-sites/css/formatura.css")?>">
...
<link href="https://fonts.googleapis.com/css2?family=Oooh+Baby&display=swap" rel="stylesheet">
    <?php $this->load->view("styles/formatura.php")?>
</head>

<body>
    <?php $this->load->view("blocos/template_casamento_content")?>
