...
?>
<div id="home" class="d-none d-sm-block home-intro bgBanner" style="background-image:url(<?=($config["bgTopo"] == "" ? base_url("templatesarq/aniversario/images/topopadrao.png") : $config["bgTopo"])?>) ;">
    <div class="container">
...
<div id="home" class="d-block d-sm-none home-intro bgBanner">
    <div class="container" style="background-image:url(<?=($config["bgTopo"] == "" ? base_url("templatesarq/aniversario/images/topopadrao.png") : $config["bgTopoMobile"])?>) ;">
        <div class="row text-center">
            <div class="col-md-12 col-sm-12 col-xs-12 topoPrincipal">
                <div class="content">
                    <h2 class="titlePrincipal"><span
