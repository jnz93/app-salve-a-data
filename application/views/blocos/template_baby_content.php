<?php $this->load->view("sites/template_baby_nav")?>
<!-- end navbar -->

<!-- home intro -->
<?php $this->load->view("blocos/bannerTopoBaby")?>
<!-- end home intro -->
    ...
    <div class="container">
        <div class="section-title">
            <h3 class="titleCentro">
                <?=($config["textoMidias"] != "" ? $config["textoMidias"] : "Álbum")?></h3>
        </div>
...
<div id="presenca" class="process-work section imgSection bgBanner">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-sm-6 text-center boxLista">
                <div class="">
                    <h3 class="titleDireito">
            ...
            <div class="col-12 col-sm-6 col-md-5 col-xs-5 boxTextoCentro  text-center">
